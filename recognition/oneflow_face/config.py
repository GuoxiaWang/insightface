...
dataset.ms1mv3 = edict()
dataset.ms1mv3.dataset = 'ms1mv3'
dataset.ms1mv3.dataset_dir = "/data/insightface/train_ofrecord/ms1mv3"
dataset.ms1mv3.num_classes = 93432
dataset.ms1mv3.total_img_num = 5179510
dataset.ms1mv3.part_name_prefix = "part-"
dataset.ms1mv3.part_name_suffix_length = 5
dataset.ms1mv3.train_data_part_num = 16
dataset.ms1mv3.shuffle = True
