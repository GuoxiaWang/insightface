...
def parse_args():
    ...
    parser.add_argument(
        '--sample_ratio', type=float, default=cfg.sample_ratio,
    ...
    # AMP setting
    parser.add_argument(
        '--fp16', type=str2bool, default=cfg.fp16, help='whether to use fp16 training')
    parser.add_argument(
        '--init_loss_scaling', type=float, default=cfg.init_loss_scaling, help='The initial loss scaling factor.')
    parser.add_argument(
        '--max_loss_scaling', type=float, default=cfg.max_loss_scaling, help='The maximum loss scaling factor.')
    parser.add_argument(
        '--incr_every_n_steps', type=int, default=cfg.incr_every_n_steps,
        help='Increases loss scaling every n consecutive steps with finite gradients.')
    parser.add_argument(
        '--decr_every_n_nan_or_inf', type=int, default=cfg.decr_every_n_nan_or_inf,
        help='Decreases loss scaling every n accumulated steps with nan or inf gradients.')
    parser.add_argument(
        '--incr_ratio', type=float, default=cfg.incr_ratio, help='The multiplier to use when increasing the loss scaling.')
    parser.add_argument(
        '--decr_ratio', type=float, default=cfg.decr_ratio,
    ...
    parser.add_argument(
        '--num_workers', type=int, default=cfg.num_workers, help='the number workers of DataLoader')
