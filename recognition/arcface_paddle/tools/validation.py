...
def parse_args():
    ...
    parser.add_argument(
        '--data_dir', type=str, default='./MS1M_v3_bin', help='train dataset directory')
    parser.add_argument(
        '--val_targets', type=tostrlist, default=["lfw", "cfp_fp", "agedb_30"], help='val targets, list or str split by comma')
    parser.add_argument(
...
if __name__ == '__main__':
    logging.basicConfig(level=logging.INFO, format="Validation: %(asctime)s - %(message)s")
